function lbbtCalc(price) {
  ...
  // taxFour = thresholdCalc(750000, Number.MAX_VALUE, 0.12);
  // taxThree = thresholdCalc(325000, 750000, 0.1);
  // taxTwo = thresholdCalc(250000, 325000, 0.05);
  // taxOne = thresholdCalc(145000, 250000, 0.02);
